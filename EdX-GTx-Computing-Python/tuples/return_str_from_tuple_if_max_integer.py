...
def find_max_sales(tuples):
     '''
     return string from the tuple that that has the highest integer 
     '''
     #PseudoCode
     #Create maxVal, movie variables
     #Iterate through the list
          #Unpack the tuples
          #Compare integer against max. 
          #If integer > max, then max = integer.
               #grab the string frm tuple into movie variable
     #return movie
