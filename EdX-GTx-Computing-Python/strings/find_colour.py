...
def find_color(myStr):
     #The input string is of format "rgb(red_val, green_val, blue_val)"
     #Grab the three values first
     items = myStr.split(",") #split by commas
     #The first item will have rgb( and last item will have )
     red = int(items[0].split("(")[1])
     blue = int(items[2].split(")")[0])
     green = int(items[1])
     # print(red, green, blue)    
 
     #Check values of three colours to give the final colour
     

     # If there are equal parts red, green, and blue, return "gray".
     if red == green == blue:
          return "gray"
     # If there are equal parts red and green, (and blue is not max) return "yellow".
     elif (max(red, blue, green) != blue) and (red == green): 
          return "yellow"
     # If there are equal parts red and blue, (and green is not max) return "purple".
     elif (max(red, blue, green) != green) and (red == blue):
          return "purple"
     # If there are equal parts green and blue, (and red is not max) return "teal".
     elif (max(red, blue, green) != red) and (green == blue):
          return "teal"
     # If there is more red than any other color, return "red".
     # If there is more green than any other color, return "green".
     # If there is more blue than any other color, return "blue".
...
print(find_color("rgb(125, 17, 125)")) #purple
print(find_color("rgb(217, 217, 217)")) #grey
...
'''
'''
A more compact method from tutorial:
